      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative w-full sm:max-w-xs">
          ...
          <input
            ...
            className="w-full rounded-lg border border-gray-300 py-2.5 pl-10 pr-4 text-sm focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
      </div>
              ...
              {loading &&
                Array.from({ length: 5 }).map((_, i) => (
                  <tr key={i} className="border-t border-gray-50">
                    <td className="px-5 py-4"><div className="h-4 w-40 animate-pulse rounded bg-gray-100" /></td>
                    ...
                    <td className="px-5 py-4"><div className="ml-auto h-4 w-16 animate-pulse rounded bg-gray-100" /></td>
                  </tr>
                ))}
                    ...
                    <tr key={u._id} className="border-t border-gray-50 hover:bg-gray-50/60">
                      ...
                      <td className="px-5 py-4">
                        <div className="flex items-center gap-2">
                          ...
                          <select
                            ...
                            className="rounded-lg border border-gray-200 bg-white px-2 py-1 text-xs text-gray-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 disabled:cursor-not-allowed disabled:opacity-50"
                          >
                      ...
                      <td className="px-5 py-4 text-right">
                        <button
                          ...
                          className="inline-flex items-center gap-1 rounded-lg px-2 py-1.5 text-rose-600 transition-all duration-200 hover:bg-rose-50 disabled:cursor-not-allowed disabled:text-gray-300 disabled:hover:bg-transparent"
                        >
                          <Trash2 size={16} />
                        </button>
                      </td>
        ...
        <div className="flex items-center justify-between border-t border-gray-100 px-5 py-3">
          ...
          <div className="flex gap-2">
            <button
              ...
              disabled={page <= 1}
              className="flex items-center gap-1 rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-medium text-gray-600 transition-all duration-200 hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-40"
            >
